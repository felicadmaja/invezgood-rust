...
//! `STOCKBIT_READY_POLL_MIN_SECS` / `STOCKBIT_READY_POLL_MAX_SECS` (default 420–600 —
...
pub const READY_POLL_MIN_SECS: u64 = 7 * 60;
...
/// Background poller: cek stockbit.com setiap 420–600 detik (7–10 menit).
...
impl ReadinessPoller {
    ...
    /// Hydrate dari Redis dulu; cek pertama segera; berikutnya setiap 420–600 detik.
