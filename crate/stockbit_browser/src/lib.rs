...
//! `STOCKBIT_READY_POLL_MIN_SECS` / `STOCKBIT_READY_POLL_MAX_SECS` (default 780–900 —
...
pub const READY_POLL_MIN_SECS: u64 = 13 * 60;
...
/// Background poller: cek stockbit.com setiap 780–900 detik (13–15 menit).
...
impl ReadinessPoller {
    ...
    /// Hydrate dari Redis dulu; cek pertama segera; berikutnya setiap 780–900 detik.
