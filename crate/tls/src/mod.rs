...
//!
//! Membaca sertifikat dari path env (default: folder certificate mrgs).
...
///
/// Default paths (selaras mrgs):
/// - `TLS_CERT_DIR`: `/home/baki1/mrgs/crate/certificate`
/// - `TLS_CERT_FILE`: `_.mariban.com_chain.crt`
...
pub fn load_tls_config() -> Result<ServerTlsConfig, Box<dyn std::error::Error + Send + Sync>> {
    let cert_dir = std::env::var("TLS_CERT_DIR")
        .unwrap_or_else(|_| "/home/baki1/mrgs/crate/certificate".into());
    let cert_file =
